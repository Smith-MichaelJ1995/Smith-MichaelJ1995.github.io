...
module.exports = "<div class=\"card card-body mb-3\">\n    <form (ngSubmit)=\"onSubmit()\">\n      <div class=\"form-group\">\n          <input type=\"text\" class=\"form-control\" name=\"text\" [(ngModel)]=\"currentLog.text\" placeholder=\"Add a log...\">\n      </div>\n      <input type=\"submit\" [value]=\"isNew == true ? 'Add New':'Edit Existing'\" [disabled]=\"!this.currentLog.text\" class=\"btn btn-light\">\n      <button type=\"button\" class=\"btn btn-warning\" (click)=\"clearState()\" [hidden]=\"!this.currentLog.text\">Clear</button>\n    </form>\n</div>"
...
var LogFormComponent = /** @class */ (function () {
    ...
    LogFormComponent.prototype.ngOnInit = function () {
        ...
        this.logService.selectedLog.subscribe(function (log) {
            if (log.id !== null) {
                _this.currentLog.id = log.id;
                _this.currentLog.text = log.text;
                _this.currentLog.date = log.date;
                _this.isNew = false;
            }
        });
    };
...
var LogService = /** @class */ (function () {
    function LogService() {
        ...
        //     {id: '2', text:"Added Bootstrap", date: new Date('12/27/2017 09:33:13')},
...
module.exports = __webpack_require__(/*! C:\Users\micha\BradTraversyAngularCourse\devlogger\src\main.ts */"./src/main.ts");
